#!/usr/bin/env python3
"""AI decision node: combines lane + obstacle + ultrasonic + traffic light."""
...
class DecisionNodeAI:
    def __init__(self) -> None:
        ...
        rospy.loginfo("[decision_ai] node started")
...
def main() -> None:
    rospy.init_node("decision_node_ai")
    DecisionNodeAI()
    rospy.spin()
